...
/**
 * A tool to detect the baud rate and extended protocol support of a Hasar
 * fiscal device.
 */
public final class HasarAutomaticDetection {
    ...
    /**
     * Open a Hasar fiscal device detecting the baud rate. The device must be
     * closed.
     *
     * @param device A fiscal device
     ...
     * closed.
     *
     * @param device A Hasar fiscal device
     * @throws Exception Throws Exception
     */
    ...
    /**
     * Detect whether a Hasar fiscal device supports the extended (STATPRN)
     * protocol. The device must be open.
     *
     * @param device A fiscal device.
     * @throws Exception Throws Exception
     */
