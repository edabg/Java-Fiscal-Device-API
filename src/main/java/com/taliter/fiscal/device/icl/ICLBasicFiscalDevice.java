 ...
 */
public abstract class ICLBasicFiscalDevice extends BasicFiscalDevice {
     ...
     */
    public ICLBasicFiscalDevice(FiscalPort port, int timeout, int maxTries, String encoding) {
